...
public class Crop {
    ...
    public static void captureImage(Context context, Fragment fragment) {
        pickImage(context, fragment, REQUEST_PICK);
    }
    ...
    private static void showImageCaptureError(Context context) {
        Toast.makeText(context.getApplicationContext(), R.string.capture__error, Toast.LENGTH_SHORT).show();
    }
